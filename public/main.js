...
const drawFive = () => {
  axios.get("https://18.117.216.101/api/robots/five").then((res) => {
...
const duel = () => {
  ...
  setTimeout(() => {
    axios
      .post("https://18.117.216.101/api/duel", { compDuo, playerDuo })
      .then(({ data }) => {
...
const getPlayerStats = () => {
  axios
    .get("https://18.117.216.101/api/player")
...
const getAllBots = () => {
  axios.get("https://18.117.216.101/api/robots").then(({ data }) => {
